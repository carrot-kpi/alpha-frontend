// This custom connector simply adds a Content-Type application/json
// header to each RPC request in order to make Pocket RPC urls work correctly.
// Code taken from https://github.com/NoahZinsmeister/web3-react/blob/v6/packages/network-connector/src/index.ts
